 ...
 */
public class SpecificInfoPO {

    public SpecificInfoPO(String date, String code, String name,String open, String close,
                          String highest, String lowest, String adj_price,
                          String volume, String turnover, String pe, String pb) {
        this.date = date;
       this.name=name;
        this.code = code;
        this.open = open;
