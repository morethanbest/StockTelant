		...
		<!-- header-starts -->
			...
			<div class="content">
                  ...
                  <table>
                    ...
                    <%
                       ChosenStockController cc=(ChosenStockController)context.getBean("ChosenStockController"); 
                       List<OriginInfoVO> al=cc.getChosenList();
                        for (OriginInfoVO vo : al) {     %>
                          <tr>
                            <td><%=vo.getDate()%></td>
                            <td>
                             <a href="<s:url action="stockInfo.action">
                            	<s:param name="stockNumber"><%=vo.getCode()%></s:param>
                            </s:url>"><%=vo.getCode()%></a>
                            <td><%=vo.getName()%></td>
                            <td><%=vo.getOpen()%></td>
                            <td><%=vo.getClose()%></td>
                           ...
                           <div class="menu">
									<ul id="menu" >
										<li><a href="home.jsp"><i class="fa fa-tachometer"></i> <span>主页</span></a></li>
										 ...
										 <li id="menu-academico" ><a href="allstock.jsp"><i class="fa fa-file-text-o"></i> <span>股票列表</span></a></li>
									<li><a href="#"><i class="fa fa-file-text-o"></i> <span>行业分析</span></a></li>
									<li id="menu-academico" ><a href="#"><i class="fa fa-file-text-o"></i> <span>股票对比</span></a></li>
									<li id="menu-academico" ><a href="#"><i class="fa fa-file-text-o"></i> <span>形势预测</span></a></li>
								  </ul>
								</div>
							  </div>
      </div>
